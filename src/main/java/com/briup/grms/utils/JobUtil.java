...
public class JobUtil{
    ...
    public static void setSecondarySort(
        Class<? extends WritableComparator> g,
        Class<? extends WritableComparator> s,
        Class<? extends Partitioner> p
